...
export class TaskService {
  ...
  async createAdhocTask(data: any): Promise<any> {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .post(`${environment.apiBaseUrl}/task`, formData)
        .subscribe((resp) => {
          resolve(resp);
        });
    });
  ...
  async deleteTask(taskId: string): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http
        .delete(`${environment.apiBaseUrl}/task/${taskId}`)
        .subscribe((resp) => {
          resolve(resp);
        });
    });
  ...
  async saveTaskDetails(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http
        .post(`${environment.apiBaseUrl}/TaskDetail`, data)
        .subscribe((resp) => {
          resolve(resp);
        });
    });
  ...
  async getTaskDetails(taskId: string): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http
        .get(`${environment.apiBaseUrl}/taskdetail/${taskId}`)
        .subscribe((resp) => {
          resolve(resp);
        });
    });
